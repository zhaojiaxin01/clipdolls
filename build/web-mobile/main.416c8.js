(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.a7ec0.js';
        if (jsList) {
    ...
    if (false) {
        (function () {
            ...
            require('src/settings.b71cf.js');
            require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.51053.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.51053.js';
