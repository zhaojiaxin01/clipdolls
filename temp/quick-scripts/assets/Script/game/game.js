...
cc._RF.push(module, '5fb149WcMtBe73QxLGm6eQb', 'game', __filename);
// Script/game/game.js
...
cc.Class({
    ...
    // 中奖信息弹框
    winAlertShow: function winAlertShow() {
        if (this.win) {
            var w1 = cc.moveTo(0.5, cc.p(-490, 100));
    ...
    onLoad: function onLoad() {
        var siteNum = globel.siteNum; // 选的是什么场;
        ...
        this.StartBtn.on("touchstart", function () {
            ...
            if (self.is_throwing) {
                ...
                var ropeAction1 = cc.moveTo(0.7, cc.p(0, 200)); // 绳子落下
                var randomY = Math.round(Math.random() * 100 + 320);
                console.log(randomY);
                var ropeAction1_1 = cc.moveTo(0.5, cc.p(0, randomY)); // 绳子返回到半空

                var ropeAction1_3 = cc.callFunc(function () {
                    var c1 = cc.rotateTo(0.1, 15);
                    var c2 = cc.rotateTo(0.2, -13);
                    var c3 = cc.rotateTo(0.2, 10);
                    var c4 = cc.rotateTo(0.2, -10);
                    var c5 = cc.rotateTo(0.2, 13);
                    var c6 = cc.rotateTo(0.2, -15);
                    var c7 = cc.rotateTo(0.2, 0);
                    var cseq = cc.sequence(c1, c2, c3, c4, c5, c6, c7);
                ...
                var mid_func = cc.callFunc(function () {
                    ...
                    switch (siteNum) {
                        case 1:
                            skin = self.pigSkin[1];break;
                        case 2:
                            skin = self.pandaSkin[1];break;
                        case 3:
                            skin = self.bearSkin[1];break;
                    }
                    ...
                    if (collider) {
                        ...
                        if (self.clipTrue) {
                            ...
                            var doll_skin = cc.callFunc(function () {
                                ...
                                switch (siteNum) {
                                    case 1:
                                        skin2 = self.pigSkin[0];break;
                                    case 2:
                                        skin2 = self.pandaSkin[0];break;
                                    case 3:
                                        skin2 = self.bearSkin[0];break;
                                }
                ...
                var end_func = cc.callFunc(function () {
                    self.scheduleOnce(function () {
                        var ropeAction2 = cc.moveTo(0.4, cc.p(0, 480)); // 绳子回到原位
                ...
                var ropeSeq = cc.sequence(ropeAction1, ropeAction1_1, ropeAction1_3, mid_func, end_func);
    ...
    init: function init(siteNum) {
        ...
        switch (siteNum) {
            case 1:
                self.siteName.getComponent(cc.RichText).string = '<outline color=#6b2a11 width=2><b>娱 乐 场</b></outline>';break;
            case 2:
                self.siteName.getComponent(cc.RichText).string = '<outline color=#6b2a11 width=2><b>五 毛 场</b></outline>';break;
            case 3:
                self.siteName.getComponent(cc.RichText).string = '<outline color=#6b2a11 width=2><b>一 元 场</b></outline>';break;
        }
    },
