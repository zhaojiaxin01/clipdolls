(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/3rd/extend.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a9ba2Z0/mBLB4h/ta2bhcbR', 'extend', __filename);
// Script/3rd/extend.js

"use strict";

// 扩展DataView 读/写字符串 -->utf8的
DataView.prototype.writeUTF8Str = function (offset, str) {
    var now = offset;
    var dataview = this;
...
DataView.prototype.readUTF8Str = function (offset, byte_length) {
    var out, i, len, c;
    var char2, char3;
    var dataview = this;
...
String.prototype.utf8StrLength = function () {
    var totalLength = 0;
    var i;
    var charCode;
